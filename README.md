# 🏦 Agentic AI OS for Indian BFSI (Customer)

> Personal banking assistant bot. Integrates WhatsApp multi-factor approval workflows.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/customer-banking-copilot/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-customer-banking-copilot.git
cd tp-customer-banking-copilot
```
...
```bash
kubectl port-forward deployment/tp-customer-banking-copilot 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── customer_bfsi.py     # Main configuration file
```
...
---
*Generated by [Agentic AI OS for Indian BFSI (Customer) Studio](https://pradeeptalari14.github.io/portfolio/tools/customer-banking-copilot/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
