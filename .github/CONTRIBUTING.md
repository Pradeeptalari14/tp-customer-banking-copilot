...
Thank you for your interest in improving the **Agentic AI OS for Indian BFSI (Customer)** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-customer-banking-copilot.git
...
Generated configurations come from the **[Agentic AI OS for Indian BFSI (Customer) Studio](https://pradeeptalari14.github.io/portfolio/tools/customer-banking-copilot/)**.
