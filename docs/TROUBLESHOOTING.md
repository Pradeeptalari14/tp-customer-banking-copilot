# 🔧 Troubleshooting Guide — Agentic AI OS for Indian BFSI (Customer)
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-customer-banking-copilot/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/customer-banking-copilot/)
